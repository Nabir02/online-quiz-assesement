...
<html>
	<head>
        ...
        <style type="text/css">
            body{
                  width: 100%;
                  background: url(image/register-background.png) ;
	...
	<body>
		<div class="reg-form">
					<h5 class="reg-page-heading" style="font-family: Noto Sans;">Register to </h5><h4 class="reg-page-subheading" style="font-family: Noto Sans;">Online Quiz</h4><br>
